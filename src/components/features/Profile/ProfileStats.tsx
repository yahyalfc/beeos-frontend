    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="relative px-6 py-8">
        ...
        <div className="relative z-[2] flex flex-col gap-2">
          ...
          <p className="text-mini text-slight">
            Lock your BeeOS NFTs to earn passive rewards and boost your earning
      ...
      <div className="relative px-6 py-8">
        ...
        <div className="relative z-[2] flex flex-col gap-2">
          ...
          <h4 className="text-lg font-medium text-white">Mint on Launchpad</h4>
          <p className="text-mini text-slight">
      ...
      <div className="relative px-6 py-8">
        ...
        <div className="relative z-[2] flex flex-col gap-2">
          ...
          <h4 className="text-lg font-medium text-white">Community Raffles</h4>
          <p className="text-mini text-slight">
